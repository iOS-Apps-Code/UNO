...
//method: prototype.updateTouchEnd
...
//method: prototype.getFocusedCell
...
global.zflow = function (images, selector)
{
    ...
    var cellCSS = {
        ...
        width: CSIZE + "px",
        height: Math.round(CSIZE * 1.0) + "px",
        opacity: 0,
    }
